...
request_db_commande = "CREATE TABLE Commandes(ID_commande varchar(20), PRIMARY KEY(ID_commande), cote_commande integer(1), prix_total float(12), date_expedition nvarchar(50), date_commande nvarchar(50))"
...
# request_commande = """INSERT INTO Commande (ID_commande, cote_commande, prix_total, date_expedition, date_commande) VALUES (%s, %s, %s, %s, %s)"""
